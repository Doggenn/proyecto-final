        ...
        <div>
            <div >
                <nav className='menuEstilo'>
                    ...
                    <Link className='estiloNav' to="/mascotas"><img className='menuImg' src="./images/Icons/icons-blue/mascota@3x.png" alt="mascotas" /></Link>
                    <Link className='estiloNav' to="/usuario"><img className='menuImg' src="./images/foto-perfil/fotodeperfil@3x.png" alt="perfil" /></Link>
                    <Link className='estiloNav' to="/mas"><img className='menuImg' src="./images/Icons/icons-blue/mS@3x.png" alt="mas" /></Link>
                </nav>
            </div>
        </div>
    )
